...
{
      // 1. Call my_username() function in autotest-validate.c to get your hard-coded username.
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(autotest_username, conf_file_username, "Usernames should match");
}
